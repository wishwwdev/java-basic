...
class Student<S extends Collection> {		// 매개타입을 Collection으로 제한한다는 의미
...
//		int weight = personalInfo.weight;
		...
		// 와일드 카드를 이용한 Generic 사용															// extends, super
		PersonalInfo<? extends Object, Integer> personalInfoWild = new PersonalInfo<>();	// (매개타입의) 하위만 받음
		PersonalInfo<? super ArrayList, Integer> personalInfoWild2 = new PersonalInfo<>();	// (매개타입의) 상위만 받음
